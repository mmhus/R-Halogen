...
void run_test_cases(void (*vect_add)(uint16_t*, uint8_t*, int, uint16_t*)) {
    ...
    for (int i = 0; i < num_tests; i++) {
        ...
        uint8_t b[8] = {0, 1, 255, 128, 64, 32, 2, 254};
        uint16_t result[8];
